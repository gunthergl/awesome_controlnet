...
Welcome to `cc_pipeline` contributor's guide.
...
If you experience bugs or general issues with `cc_pipeline`, please have a look
...
You can help improve `cc_pipeline` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`cc_pipeline` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `cc_pipeline`'s files. While this mechanism can
...
```
conda create -n cc_pipeline python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/cc_pipeline.git
   cd cc_pipeline
   ```
...
5. Install [pre-commit]:
   ...
   `cc_pipeline` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/cc_pipeline
[issue tracker]: https://github.com/<USERNAME>/cc_pipeline/issues
